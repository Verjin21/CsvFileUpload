...
if($result){
	$rows=mysqli_num_rows(mysqli_result ($result));
}
...
<body style="background-image: linear-gradient(-90deg, rgb(5, 63, 255), rgb(184, 15, 15));margin-top:20%;color:white">    
...
<?php
	...
	<h1 style="text-align: center;">Something went Wrong..........!</h1>	</body>
	<?php
	}
?>